// src/models/postgres/machineDao.js
 ...
 */
export async function findMachines(client, { plant, workCenter, materialCode }) {
    const values = [];
    const where = [`F.level = '5'`];
    ...
    //     // machine 연쇄: prod_order의 zcf_machine_cd = F.lvcd
    //     existsConds.push('P.zcf_machine_cd = F.lvcd');
