// src/pages/Defect_Management_VJ2_VJ3_INT.tsx
import '../MyApp.css'
import './Defect_Management_VJ2_VJ3_INT_POPUP.css'
import Defect_Management_VJ2_VJ3_INT_POPUP from './Defect_Management_VJ2_VJ3_INT_POPUP'
...
export default function Defect_Management_Lean_Line_INT(): JSX.Element {
  ...
  return (
    <div className={debugMode ? 'dev-main' : ''} style={{ height: '98vh', display: 'flex', flexDirection: 'column', backgroundColor: debugMode ? '#00ccff' : '#f5f6f7' }}>
      ...
      <Defect_Management_VJ2_VJ3_INT_POPUP
        isOpen={popupOpen}
