// src/pages/Defect_Management_BTM_INT.tsx
import '../MyApp.css'
import './Defect_Management_BTM_INT.css'
import Defect_Management_BTM_INT_POPUP from './Defect_Management_BTM_INT_POPUP'
...
export default function Defect_Management_BTM_INT(): JSX.Element {
  ...
  const columns = [
    ...
    { Header: "MCS Name", accessor: "zcf_mcs_cd" },
    { Header: "MCS Color", accessor: "zcf_mcs_color_nm" },
    { Header: "Mold ID", accessor: "mold_id" },
    { Header: "Grade Type", accessor: "grade_type" },
    { Header: "Scrap/Return", accessor: "defect_decision" },
    { Header: "Reason", accessor: "defect_reason_name" },
    { Header: "Mold Set", accessor: "mold_set" },
    ...
    { Header: "Self Inspection", accessor: "SelfCheck" },
  ];
  ...
  return (
    <div className={debugMode ? 'dev-main' : ''} style={{ height: '98vh', display: 'flex', flexDirection: 'column', backgroundColor: debugMode ? '#00ccff' : '#f5f6f7' }}>
      ...
      <Defect_Management_BTM_INT_POPUP
        isOpen={popupOpen}
