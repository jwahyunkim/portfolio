// src/pages/Defect_Management_BTM_ENT.tsx 
import '../MyApp.css'
import './Defect_Management_BTM_ENT.css'
import Defect_Management_BTM_ENT_POPUP from './Defect_Management_BTM_ENT_POPUP'
...
export default function Defect_Management_BTM_ENT(): JSX.Element {
  ...
  const columns = [
    ...
    { Header: "Confirm", accessor: 'cfm_yn' },
  ...
  return (
    <div className={debugMode ? 'dev-main' : ''} style={{ height: '98vh', display: 'flex', flexDirection: 'column', backgroundColor: debugMode ? '#00ccff' : '#f5f6f7' }}>
      ...
      <Defect_Management_BTM_ENT_POPUP
        isOpen={popupOpen}
